...
class OrderTable extends Table
{
    ...
    protected const FIELDS = [
        'order_id' => [Field::T_INT, null, 8, 17, 0, 'nextval(\'tbl_order_order_id_seq\'::regclass)', true, false],
        'state_id' => [Field::T_INT, null, 2, 4, 0, null, false, false],
        ...
        'date_created' => [Field::T_DATETIME_TZ, null, null, 0, null, 'CURRENT_TIMESTAMP', true, false],
    ];
